...
<div className='flex flex-wrap flex-row mt-2 w-full  justify-start relative items-center gap-[2rem] '>
       ...
       <a className='social'>
       <svg className='cursor-pointer' width="35" height="35" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clip-rule="evenodd" d="M18.858 17.938H26.286V21.638C27.356 19.51 30.1 17.598 34.222 17.598C42.124 17.598 44 21.834 44 29.606V44H36V31.376C36 26.95 34.93 24.454 32.206 24.454C28.428 24.454 26.858 27.144 26.858 31.374V44H18.858V17.938ZM5.14 43.66H13.14V17.598H5.14V43.66ZM14.286 9.1C14.2863 9.77055 14.1533 10.4345 13.8948 11.0532C13.6362 11.6719 13.2573 12.233 12.78 12.704C11.8128 13.6652 10.5036 14.2033 9.14 14.2C7.77878 14.1991 6.47262 13.6624 5.504 12.706C5.02842 12.2334 4.65077 11.6716 4.39269 11.0529C4.1346 10.4341 4.00116 9.77045 4 9.1C4 7.746 4.54 6.45 5.506 5.494C6.47377 4.53632 7.78048 3.9994 9.142 4C10.506 4 11.814 4.538 12.78 5.494C13.744 6.45 14.286 7.746 14.286 9.1Z" fill="#363625"/>
              </svg>
       </a>
       </Link>
        <a href='https://drive.google.com/file/d/1JdpG64Hbtr3JbzaeCp86EteTbf_WIXCc/view' target='_blank'>
          <span className='px-[2rem] py-2 text-[#363625] bg-[white] rounded-xl '>
          Curriculum Vitæ 
          </span>
        </a> 
        ...
        <UpDown>
          <a href='#skills'>
          <svg  className='cursor-pointer svg' width="48" height="36" viewBox="0 0 57 36" fill="none" xmlns="http://www.w3.org/2000/svg">
